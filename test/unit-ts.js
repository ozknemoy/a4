...
var now = JSON.stringify(new Date()).slice(1, -1);
var arr = ['Идея', 'Стартап', 1];
var arrOfObj = [
...
function assertCount(a, output, description, repeat) {
    if (repeat === void 0) { repeat = 100000; }
...
var handle_data_class_1 = require("../src/services/handle-data.class");
var HD = new handle_data_class_1.HandleDataClass();
